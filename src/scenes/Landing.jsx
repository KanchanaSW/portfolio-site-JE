            ...
            <div className="z-30 basis-2/5 mt-12 md:mt-32">
                ...
                >
                    ...
                    <p className="mt-10 mb-7 text-sm text-center md:text-start">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas consequuntur optio natus in nisi alias, quae, tenetur voluptatem modi consectetur numquam dolor? Voluptatibus, doloremque vel corporis soluta tempora odio quibusdam?
                    </p>
                </motion.div>
